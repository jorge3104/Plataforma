...
$phpWord = new \PhpOffice\PhpWord\TemplateProcessor('Plantillas/CONVENIO-SERVICIOSOCIAL.docx');
...
header('Content-Disposition: attachnent; filename="CONVENIO-SERVICIOSOCIAL.docx"');
