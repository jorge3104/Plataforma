...
$destino = "archivos/" . $nombre; /*direccion de donde se van a guardar carpeta*/
...
<form class="fromulario-entrada" method="POST" action="purebaArc.php" enctype="multipart/form-data">
<fieldset>
