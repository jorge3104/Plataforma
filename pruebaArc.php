...
$destino = "archivos/$RFC" . $nombre; /*direccion de donde se van a guardar carpeta*/
$query = "INSERT INTO datos_e (RFC_ID, tipo_A, Tipo_E) VALUES
        ('$RFC','$Acuerdo', '$TEmpresa')";
        $resultado1 = mysqli_query($mysqli,$query);
if ($nombre != ""){
    if (copy($ruta, $destino)){
        $query = "UPDATE datos_e SET ArchivoComprobante= '$nombre' WHERE datos_e.RFC_ID = '$RFC'";/*solo aplica para cargar el documento Sevicio con privada */
...
<form class="fromulario-entrada" method="POST" action="pruebaArc.php" enctype="multipart/form-data">
<fieldset>
