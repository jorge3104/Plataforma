...
$errores = [];
 ...
 $sqlempresa = "SELECT ID_Datos FROM datos_e WHERE Nombre_E = '$NombreE' AND  correo = '$Correo'";
...
$query5 = "INSERT INTO  actividades (idActividades, D_A, Total_H,  Horario_E, Horario_S) VALUES ('', '$Desc_A', '$Total_H', '$Horas_E', '$Horas_S')";
...
$query2 = "INSERT INTO escritura (idEscritura_P, Numero_Esc, F_D, F_M, F_A, Otorgada, Notaria, Reg_P, Folio_Mercantil, Actividades)
VALUES ('', '$Numero_Esc', '$F_D', '$F_M', '$F_A', '$Otorgada', '$Notaria', '$Reg_P', '$Folio', '$Actividades')";
$resultados = mysqli_query($mysqli,$query2);

//INSERTA Datosde la tabla representante_esc
$query3 = "INSERT INTO representantel_esc (idRepresentante_Esc, N_Esc, F_D, F_M, F_A, Otorgada, Notaria, Entidad_Otor, RFC, calle, numero, colonia, municipio, Ent_F,  C_P) 
VALUES ('', '$Numero_EscR', '$Dia_R','$Mes_R', '$Año_R', '$OtorgadaR', '$NotariaR','$Entidad_Otor', '$RFC', '$Calle_R', '$numero_R', '$colonia_R', '$municipio_R', '$estado_R', '$codigoR')";
$resultado4 = mysqli_query($mysqli,$query3); 


//INSERTA Datosde la tabla datos acuerdo (datos_a)
$query4 = "INSERT INTO acuerdo_a (id_A, FechaV_Inicio, FechaV_Final, Testigo) VALUES ('', '$Vigencia_I', '$Vigencia_F', '$testigo')";
$resultado5 = mysqli_query($mysqli,$query4);

$phpWord = new \PhpOffice\PhpWord\TemplateProcessor('Plantillas/CONVENIO_DUAL_EMPRESASPRIV.docx');
...
$phpWord->setValue('Total_H',$Total_H);
$phpWord->setValue('Horas_E',$Horas_E);
$phpWord->setValue('Horas_S',$Horas_S);
...
header('Content-Disposition: attachnent; filename="CONVENIO_DUAL_EMPRESASPRIV.docx"');
